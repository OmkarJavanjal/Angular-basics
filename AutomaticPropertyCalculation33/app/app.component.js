...
var AppComponent = (function () {
    ...
    AppComponent.prototype.toggleHeights = function () {
        ...
        core_1.Component({
            ...
            animations: [
                core_1.trigger('lightsOnOff', [core_1.state('off', core_1.style({
                    ...
                    core_1.transition('off=>on', [core_1.animate('2000ms ease-in', core_1.style({ transform: 'rotate(90deg)' }))]),
                    core_1.transition('on=>off', [core_1.animate('2s ease-out', core_1.style({ transform: 'rotate(90deg)' }))])
                ]),
                core_1.trigger('heightTrigger', [core_1.state('noHeight', core_1.style({
                        height: 0
                    })),
                    core_1.state('fullHeight', core_1.style({
                        height: '*'
                    })),
                    core_1.transition('noHeight<=>fullHeight', [core_1.animate('2000ms')]),
                ])
            ]
        })
    ], AppComponent);
